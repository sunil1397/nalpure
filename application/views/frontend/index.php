...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded" style="background-image:url('<?php echo base_url('assets') ?>/images/demo/backgrounds/ab.jpeg');">
...
<div class="wrapper row3">
  <figure class="hoc container clear"> 
    ...
    <ul class="nospace group overview">
      <li class="one_third"><a href="#"><img src="<?php echo base_url('assets') ?>/images/demo/320x240.png" alt=""></a></li>
      <li class="one_third"><a href="#"><img src="<?php echo base_url('assets') ?>/images/demo/320x240.png" alt=""></a></li>
      <li class="one_third"><a href="#"><img src="<?php echo base_url('assets') ?>/images/demo/320x240.png" alt=""></a></li>
      <li class="one_third"><a href="#"><img src="<?php echo base_url('assets') ?>/images/demo/320x240.png" alt=""></a></li>
      <li class="one_third"><a href="#"><img src="<?php echo base_url('assets') ?>/images/demo/320x240.png" alt=""></a></li>
...
<div class="wrapper row2">
  <section class="hoc container clear testimonials"> 
    ...
    <article class="btmspace-80">
      ...
      <figure class="clear"><img src="<?php echo base_url('assets') ?>/images/demo/60x60.png" alt="">
        <figcaption>
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="group latest">
      <article class="one_half first"><a href="#"><img src="<?php echo base_url('assets') ?>/images/demo/474x356.png" alt=""></a>
        <div class="excerpt">
      ...
      <article class="one_half"><a href="#"><img src="<?php echo base_url('assets') ?>/images/demo/474x356.png" alt=""></a>
        <div class="excerpt">
